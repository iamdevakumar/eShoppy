...
import com.eclat.firebreathers.epos.Adapters.Product_Offer_Adapter;
import com.eclat.firebreathers.epos.AsyncTasks.Product_Offer_Async;
import com.eclat.firebreathers.epos.Interface.Product_offer_interface;
...
public class Product_Offer_Frag extends Fragment implements Product_offer_interface {
    ...
    public void onResume() {
        super.onResume();
        Config.backstack_state = config.product_offer_frag;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new Product_Offer_Async(getContext(), this).execute();
    ...
    @Override
    public void productOfferInterface(String jsonData, String user_id) {
        Product_Offer_Adapter adapter;
        if (user_id.equals("1")) {
            if (jsonData != null) {
                ...
                try {
                    ...
                    adapter = new Product_Offer_Adapter(getContext(), proimgname, proimgurl, proprice, proid, user_id);
            ...
            if (jsonData != null) {
                ...
                try {
                    ...
                    adapter = new Product_Offer_Adapter(getContext(), proimgname, proimgurl, proprice, proid, flags, user_id);
                    mRecyclerView.setAdapter(adapter);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
