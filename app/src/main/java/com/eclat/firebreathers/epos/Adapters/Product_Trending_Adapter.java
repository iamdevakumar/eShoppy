...
public class Product_Trending_Adapter extends RecyclerView.Adapter<Product_Trending_Adapter.ViewHolder> {
    ...
    public Product_Trending_Adapter(Context ctx, List<String> proimgname, List<String> proimgurl, List<String> proprice, List<String> proid, List<String> flags, String user_id) {
        this.proid = proid;
    ...
    public Product_Trending_Adapter(Context ctx, List<String> proimgname, List<String> proimgurl, List<String> proprice, List<String> proid, String user_id) {
        this.proid = proid;
        this.proimgname = proimgname;
        this.proimgurl = proimgurl;
        this.proprice = proprice;
